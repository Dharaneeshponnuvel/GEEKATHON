	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">
		 ...
		 <div class="col-md-4 about-grids">
			 ...
			 <p>Vacation is a time to relax in safe surroundings.For emergency aid of any kind, call 100 from any phone... in your hotel, dial 9-911.</p>
...
<?php }?>
	...
	<div class="col-md-3 image-grid">
					 <img src="images/ad.jpg" width="300px" height="150px" >

					 <p><a href="https://www.flipkart.com/">Special Offers on Travel Bags.</a></p>
				 </div>
				<?php if($n%4==3)
				{?>
            </div>
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">EXPLORE EASE</h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert.</p>
						<h5 style="color:#000"><span class="img1"></span>(+91) 8189865094&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;6379709001</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">sibinagarjun.22bce8735@vitapstudent.ac.in</a></h5>
						<h5 style="color:#000"><span class="img3"></span><a href="https://www.google.com/maps/place/VIT-AP+University/@16.4962828,80.4980927,17z/data=!3m1!4b1!4m6!3m5!1s0x3a35f27d40f21c55:0x1490eacd54859850!8m2!3d16.4962777!4d80.5006676!16s%2Fg%2F11gnsnjyhf?entry=ttu">VITAP University, Guntur district.</a></h5>
                        <br/>
